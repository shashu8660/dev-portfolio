      ...
      <div className="container">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-600 dark:text-slate-400">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/shashu8660" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-slate-900 dark:hover:text-white transform-gpu transition duration-200 ease-out hover:-translate-y-0.5">
            ...
            <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-slate-900 dark:hover:text-white transform-gpu transition duration-200 ease-out hover:-translate-y-0.5">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
